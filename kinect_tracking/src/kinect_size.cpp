...
{
  // Initialize ROS
  ros::init (argc, argv, "kinect_size_compare");
  ros::NodeHandle nh;

  // Create a ROS subscriber for the input point cloud
  ros::Subscriber sub = nh.subscribe ("/kinect_person_output", 1, cloud_cb);

  // Create a ROS publisher for the output point cloud
  pub = nh.advertise<sensor_msgs::PointCloud2> ("kinect_correct_person_output", 1);
